...
for root, dirs, files in os.walk("C:/Users/Lae/PycharmProjects/MLPClassifierPokemon/Pictures/" + folder_name + "/",
    topdown=False):
        for name in dirs:
...
y_pred_test = PneumoniaClassifier.predict(X_test)
accuracy = accuracy_score(y_test, y_pred_test)
print(accuracy)


model = 'model.pkl'
modelObject = open(model, 'wb')
pickle.dump(PneumoniaClassifier, modelObject)
modelObject.close()

loaded_model = pickle.load(open("C:/Users/Lae/PycharmProjects/model.pkl", 'rb'))
